...
<body>
    ...
    <td class="style2"> <center><h1 style="height: 36px">Phenomenal Geeks</h1></td>
    </tr>
    </table>
     <br />
      <div class="navbar">
...
<script>
    ...
    <table>
    <tr>
    <td><asp:Label ID="lblID" runat="server" Text="EmailID"/></td>
    ...
    <td><asp:Button ID="btnSubmit" runat="server" Text="Submit" 
                    onclick="btnSubmit_Click" style="height: 26px" CausesValidation="True" /></td>
    </tr>
    </table>
    </center>
    </form>
